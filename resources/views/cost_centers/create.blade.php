                    ...
                    <form action="{{ route('cost_centers.store') }}" method="POST">
                            ...
                            <div>
                                ...
                                <select name="company_id" id="company_id" class="w-full border-gray-200 dark:border-gray-700 dark:bg-gray-900 rounded-2xl shadow-sm focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold py-3" required>
                                    ...
                                    @foreach($companies as $company)
                                        <option value="{{ $company->id }}" {{ old('company_id') == $company->id ? 'selected' : '' }}>{{ $company->name }} - {{ $company->account }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="email" name="menfis_email" id="menfis_email" value="{{ old('menfis_email') }}" class="w-full border-gray-200 dark:border-gray-700 dark:bg-gray-900 rounded-2xl shadow-sm focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold py-3" placeholder="correo@ejemplo.com">
                            </div>
                            <div>
                                ...
                                <input type="text" name="description" id="description" value="{{ old('description') }}" class="w-full border-gray-200 dark:border-gray-700 dark:bg-gray-900 rounded-2xl shadow-sm focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-medium py-3">
                            </div>
                        </div>
