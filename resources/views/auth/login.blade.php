<x-guest-layout>
    ...
    <div class="mt-6">
        ...
        <div class="space-y-4">
            <div>
                <p class="mb-2 text-center text-sm font-bold text-gray-800">¿Tu correo termina en <span class="text-indigo-700">@grupoindi.com</span> o <span class="text-indigo-700">@construlerma.com</span>?</p>
            ...
            <div class="border-t border-gray-200 pt-4">
                <p class="mb-2 text-center text-sm font-bold text-gray-800">¿Tu correo termina en <span class="text-indigo-700">@archandel.com</span>?</p>
