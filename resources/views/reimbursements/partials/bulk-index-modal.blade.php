                ...
                <div class="px-6 pt-6 pb-6">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            <h3 class="text-xl leading-6 font-black text-gray-900 dark:text-white mb-2">
                                Acción Masiva
                            </h3>
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <ul class="mt-1 text-xs font-medium text-amber-700 dark:text-amber-400 list-disc ml-4 space-y-1">
                                                <li x-show="missingUuidCount > 0"><span x-text="missingUuidCount"></span> ticket(s) sin factura distribuidos en los grupos.</li>
                                                <li x-show="mismatchCount > 0"><span x-text="mismatchCount"></span> trámite(s) con UUID o Monto discordantes.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
