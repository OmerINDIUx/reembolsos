                ...
                <div class="p-8 md:p-12 text-gray-900 dark:text-gray-100">
                    <h3 class="text-3xl font-black text-center mb-12 uppercase tracking-tight">¿Qué tipo de solicitud deseas registrar?</h3>
                        ...
                        <button type="button" @click="askForInvoice('reembolso')" class="group block text-left">
                            <div class="p-8 bg-white dark:bg-gray-700 border-4 border-gray-100 dark:border-gray-600 rounded-[2.5rem] hover:border-indigo-500 hover:shadow-2xl transition-all text-center h-full flex flex-col items-center justify-center group-hover:bg-indigo-50 dark:group-hover:bg-gray-600">
                                ...
                                <h4 class="text-xl font-black text-gray-900 dark:text-white mb-3 uppercase tracking-tighter">Reembolso</h4>
                                <p class="text-[10px] font-bold text-gray-400 dark:text-gray-400 uppercase tracking-widest leading-loose">Gastos generales realizados con recursos propios.</p>
                            </div>
                        </button>
                        ...
                        @if($isMarkedInAnyCC)
                            @if($isPrivilegedInCC)
                                ...
                                <button type="button" @click="askForInvoice('fondo_fijo')" class="group block text-left">
                                    <div class="p-8 bg-white dark:bg-gray-700 border-4 border-gray-100 dark:border-gray-600 rounded-[2.5rem] hover:border-green-500 hover:shadow-2xl transition-all text-center h-full flex flex-col items-center justify-center group-hover:bg-green-50 dark:group-hover:bg-gray-600">
                                        ...
                                        <h4 class="text-xl font-black text-gray-900 dark:text-white mb-3 uppercase tracking-tighter">Fondo Fijo</h4>
                                        <p class="text-[10px] font-bold text-gray-400 dark:text-gray-400 uppercase tracking-widest leading-loose">Comprobación de caja chica o fondo.</p>
                                    </div>
                                </button>

                                <!-- Comida -->
                                <button type="button" @click="askForInvoice('comida')" class="group block text-left">
                                    <div class="p-8 bg-white dark:bg-gray-700 border-4 border-gray-100 dark:border-gray-600 rounded-[2.5rem] hover:border-orange-500 hover:shadow-2xl transition-all text-center h-full flex flex-col items-center justify-center group-hover:bg-orange-50 dark:group-hover:bg-gray-600">
                                        ...
                                        <h4 class="text-xl font-black text-gray-900 dark:text-white mb-3 uppercase tracking-tighter">Comida</h4>
                                        <p class="text-[10px] font-bold text-gray-400 dark:text-gray-400 uppercase tracking-widest leading-loose">Representación o alimentación.</p>
                                    </div>
                                </button>
                            @endif

                            @if($isPrivilegedInCC || (isset($hasActiveTrip) && $hasActiveTrip))
                                <!-- Viaje -->
                                <button type="button" @click="askForInvoice('viaje')" class="group block text-left">
                                    <div class="p-8 bg-white dark:bg-gray-700 border-4 border-gray-100 dark:border-gray-600 rounded-[2.5rem] hover:border-blue-500 hover:shadow-2xl transition-all text-center h-full flex flex-col items-center justify-center group-hover:bg-blue-50 dark:group-hover:bg-gray-600">
                                        <div class="bg-blue-100 dark:bg-blue-900 p-6 rounded-3xl mb-6 group-hover:scale-110 transition-transform shadow-inner">
                                            <svg class="w-12 h-12 text-blue-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                        </div>
                                        <h4 class="text-xl font-black text-gray-900 dark:text-white mb-3 uppercase tracking-tighter">Viajes</h4>
                                        <p class="text-[10px] font-bold text-gray-400 dark:text-gray-400 uppercase tracking-widest leading-loose">Asociado a un Viaje o Evento Corporativo.</p>
                                    </div>
                                </button>
                            @endif
                        @endif
