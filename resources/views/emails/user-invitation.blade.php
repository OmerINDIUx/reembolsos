...
@section('content')
    ...
    <p>Para comenzar a utilizar tu cuenta y registrar tus gastos, por favor activa tu acceso iniciando sesión con tu cuenta corporativa de {{ $provider }} a través del siguiente botón:</p>
