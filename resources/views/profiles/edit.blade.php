    ...
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Editar Perfil:') }} <span class="text-indigo-600 dark:text-indigo-400 font-black uppercase">{{ $profile->display_name }}</span>
            </h2>
        </div>
    </x-slot>
                    ...
                    <div class="p-8 border-b border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/20">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            @if(in_array($profile->name, ['admin', 'director', 'accountant']))
                                <span class="px-3 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 text-[10px] font-black uppercase tracking-[0.2em] rounded-full border border-amber-200 dark:border-amber-800">Perfil de Sistema</span>
                            @endif
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input type="text" name="description" id="description" value="{{ old('description', $profile->description) }}"
                                    class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-all duration-200 placeholder-gray-400"
                    ...
                    <div class="p-8">
                        <div class="flex items-center justify-between mb-8">
                            ...
                            <div class="space-x-4">
                                ...
                                <button type="button" onclick="toggleAllPermissions(false)" class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest hover:underline">Limpiar</button>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900/40 rounded-2xl p-6 border border-gray-100 dark:border-gray-700/50 hover:shadow-md transition-shadow duration-300">
                                <div class="flex items-center justify-between mb-4 border-b border-gray-200 dark:border-gray-700 pb-3">
                                    ...
                                    <input type="checkbox" onchange="toggleModulePermissions('{{ $module }}', this.checked)" class="rounded-md border-gray-300 text-indigo-600 focus:ring-indigo-500 shadow-sm">
                                </div>
                                <div class="space-y-3">
